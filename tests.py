...
class TestStringMethods(unittest.TestCase):
    ...
    def test_reason_type_comparison(self):
        ...
        self.assertTrue(reason_checks.reason_type_equal(refdata_reason, stock_reason))

        stock_reason['reasontype'] = 'DEBIT'
        self.assertFalse(reason_checks.reason_type_equal(refdata_reason, stock_reason))
    ...
    def test_reason_properties_equal(self):
        ...
        self.assertTrue(reason_checks.reason_properties_equal(refdata_reason, stock_reason))

        stock_reason['description'] = 'different'
        self.assertFalse(reason_checks.reason_properties_equal(refdata_reason, stock_reason))
